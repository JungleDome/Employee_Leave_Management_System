 ...
 * @author TP041331
 */
public class AL_ViewHoliday extends javax.swing.JFrame {

    /**
     * Creates new form L_ViewHoliday
     */
    public AL_ViewHoliday() {
        initComponents();
    ...
    private void initComponents() {
        ...
        setTitle("View Holiday (Academic Leader)");
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "No.", "Holiday Name", "Date", "Holiday Type"
            }
        ) {
    ...
    private void formComponentShown(java.awt.event.ComponentEvent evt) {//GEN-FIRST:event_formComponentShown
        ...
        List<PublicHoliday> ListPH = PublicHoliday.getAllPublicHoliday();

        for (int i = 0; i < ListPH.size(); i++) {
            PublicHoliday PH = ListPH.get(i);
            Object[] row = {i+1,PH.title,PH.date,PH.type};
            tm.addRow(row);
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AL_ViewHoliday.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
